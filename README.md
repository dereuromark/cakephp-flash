...
[![Build Status](https://api.travis-ci.com/dereuromark/cakephp-flash.png?branch=master)](https://travis-ci.com/dereuromark/cakephp-flash)
...
This branch is for **CakePHP 3.8+**. See [version map](https://github.com/dereuromark/cakephp-flash/wiki#cakephp-version-map) for details.
